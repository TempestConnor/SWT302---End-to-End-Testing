...
Scenario("Test Invalid Day Input - Non-numeric", ({ I }) => {
  ...
  I.click("Check");
  I.waitForText('Input data for "Day" incorrect format!', 1);
  I.wait(2);
});
...
Scenario("Test Invalid Month Input - Non-numeric", ({ I }) => {
  ...
  I.click("Check");
  I.waitForText('Input data for "Month" incorrect format!', 1);
  I.wait(2);
});
...
Scenario("Test Invalid Year Input - Non-numeric", ({ I }) => {
  ...
  I.click("Check");
  I.waitForText('Input data for "Year" incorrect format!', 1);
  I.wait(2);
});
